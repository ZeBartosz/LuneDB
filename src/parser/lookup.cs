namespace LuneDB
{
    public class Lookup
    {
        ...
        // Optional helper registration methods
        ...
        public void RegisterBp(Token.TokenType type, binding_power bindingPower) => BpLookup[type] = bindingPower;
    }
    ...
    public class GlobalLookup
    {
        ...
        public static Dictionary<Token.TokenType, Lookup.binding_power> bp_lu => LookupTable.BpLookup;
        public static Dictionary<Token.TokenType, Func<Parser, IExpr>> nud_lu => LookupTable.NudLookup;
        public static Dictionary<Token.TokenType, Func<Parser, IExpr, Lookup.binding_power, IExpr>> led_lu => LookupTable.LedLookup;
        public static Dictionary<Token.TokenType, Func<Parser, IStmt>> stmt_lu => LookupTable.StmtLookup;

        public static void createLookup()
        {
            LookupTable.RegisterNud(Token.TokenType.IDENTIFIER, ParserPrimaryExpr);
